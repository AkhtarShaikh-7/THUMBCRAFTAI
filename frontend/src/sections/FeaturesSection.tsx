            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <img className="h-full w-auto" src="https://images.stockcake.com/public/5/5/8/558153e2-ce29-4ed1-97f6-959a133e52f1/technology-meets-teamwork-stockcake.jpg" alt="features showcase" width={1000} height={500} />
                    </motion.div>
                    ...
                    >
                        ...
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcST6d4fsG22tzvEYJJrx1XXqL1A1gk4t4Nx-w&s" alt="features showcase" width={1000} height={500} className="hover:-translate-y-0.5 transition duration-300" />
                        ...
                        <a href="/generate" className="group flex items-center gap-2 mt-4 text-orange-600 hover:text-orange-700 transition">
